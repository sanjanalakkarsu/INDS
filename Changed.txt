...
def individual_feasibility(compatible_devices):
...
def individual():
    ...
    individual = individual_feasibility(compatible_devices)
    show_summary_window1(individual)
...
summarize_button1 = tk.Button(root, text="Individual Feasibility", command=individual, font=("Helvetica", 10, "bold"))
